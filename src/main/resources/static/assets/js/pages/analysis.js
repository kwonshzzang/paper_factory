...
ANALYSIS.INIT = function(){
	...
	ANALYSIS.REQ.LOAD_STATUS_HISTORY();
	ANALYSIS.UI.SET_ANALYSIS_HISTORY();
};
 ...
 *
 *******************************/
ANALYSIS.REQ.LOAD_STATUS_HISTORY = function(){
	...
	RM.GET_ANALYSIS({
		...
		ANALYSIS.UI.SET_STATUS_HISTORY(list);
	});
};
 ...
 *
 *******************************/
ANALYSIS.UI.SET_STATUS_HISTORY = function(list){
	...
	$.each(list, function(i, item){
		var tr = ANALYSIS.UI.CREATE_STATUS_ITEM(item);
...
ANALYSIS.UI.CREATE_STATUS_ITEM = function(item){
	var tr = $("<tr/>");
	var td_id = $("<td/>");
	var td_timestamp = $("<td/>");
	var td_spa = $("<td/>");
...
ANALYSIS.UI.SET_ANALYSIS_HISTORY = function(){	
